...
export const projects: Project[] = [
  {
    ...
    images: [
      { src: '/assets/projects/ankiugen/Ankiugen(1).svg', alt: 'Ankiugen project screenshot (1)' },
      { src: '/assets/projects/ankiugen/Ankiugen(2).svg', alt: 'Ankiugen project screenshot (2)' },
      { src: '/assets/projects/ankiugen/Ankiugen(3).svg', alt: 'Ankiugen project screenshot (3)' },
      { src: '/assets/projects/ankiugen/Ankiugen(4).svg', alt: 'Ankiugen project screenshot (4)' },
      { src: '/assets/projects/ankiugen/Ankiugen(5).svg', alt: 'Ankiugen project screenshot (5)' },
      { src: '/assets/projects/ankiugen/Ankiugen(6).svg', alt: 'Ankiugen project screenshot (6)' },
      { src: '/assets/projects/ankiugen/Ankiugen(7).svg', alt: 'Ankiugen project screenshot (7)' },
      { src: '/assets/projects/ankiugen/Ankiugen(8).svg', alt: 'Ankiugen project screenshot (8)' },
      // { src: '/assets/projects/ankiugen/Ankiugen().svg', alt: 'Ankiugen project screenshot ()' },
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/portfolio/portfolio(2).svg', alt: 'Portfolio Project Screenshot (2)' },
      { src: '/assets/projects/portfolio/portfolio(1).svg', alt: 'Portfolio Project Screenshot (1)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/text-only-apkg-writer/textonlyapkgwriter.svg', alt: 'Text-only .apkg Writer' },
      { src: '/assets/projects/text-only-apkg-writer/textonlyapkgwriter-2.svg', alt: 'Text-only .apkg Writer (2)' },
    ],
    description:
  ...
  },
  {
    title: 'BashMaster AI',
    images: [
      { src: '/assets/projects/bashmaster-ai/BashMasterAI.svg', alt: 'BashMaster AI' },
      { src: '/assets/projects/bashmaster-ai/BashMasterAI-2.svg', alt: 'BashMaster AI (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/python-training-grounds/pythontraininggrounds.svg', alt: 'Python Training Grounds' },
      { src: '/assets/projects/python-training-grounds/pythontraininggrounds-2.svg', alt: 'Python Training Grounds (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/go-concurrency-lab/goconcurrencylab.svg', alt: 'Go Concurrency Lab' },
      { src: '/assets/projects/go-concurrency-lab/goconcurrencylab-2.svg', alt: 'Go Concurrency Lab (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/learn-go-with-tdd/go_with_tdd.svg', alt: 'Learn Go with TDD screenshot' },
      { src: '/assets/projects/learn-go-with-tdd/go_with_tdd-2.svg', alt: 'Learn Go with TDD screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/frontend-capstone/frontend.svg', alt: 'Frontend Project Screenshot' },
      { src: '/assets/projects/frontend-capstone/frontend-2.svg', alt: 'Frontend Project Screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/devops-capstone/DevOps.svg', alt: 'DevOps Project Screenshot' },
      { src: '/assets/projects/devops-capstone/DevOps-2.svg', alt: 'DevOps Project Screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/backend-capstone/backend.svg', alt: 'Backend Project Screenshot' },
      { src: '/assets/projects/backend-capstone/backend-2.svg', alt: 'Backend Project Screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/songs-backend-capstone/Songs.svg', alt: 'Songs Project Screenshot' },
      { src: '/assets/projects/songs-backend-capstone/Songs-2.svg', alt: 'Songs Project Screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/pictures-backend-capstone/Pictures.svg', alt: 'Pictures Project Screenshot' },
      { src: '/assets/projects/pictures-backend-capstone/Pictures-2.svg', alt: 'Pictures Project Screenshot (2)' },
    ],
    description:
  ...
  },
  {
    ...
    images: [
      { src: '/assets/projects/tdd-bdd/TDD_BDD.svg', alt: 'TDD and BDD Project screenshot' },
      { src: '/assets/projects/tdd-bdd/TDD_BDD-2.svg', alt: 'TDD and BDD Project screenshot (2)' },
    ],
    description:
