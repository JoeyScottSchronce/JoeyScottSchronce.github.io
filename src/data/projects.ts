...
export const projects: Project[] = [
  {
    title: 'Ankiugen - Flashcard Generator',
    images: [
      { src: '/assets/projects/ankiugen/Ankiugen(1).webp', alt: 'Ankiugen project screenshot (1)' },
      { src: '/assets/projects/ankiugen/Ankiugen(2).webp', alt: 'Ankiugen project screenshot (2)' },
      { src: '/assets/projects/ankiugen/Ankiugen(3).webp', alt: 'Ankiugen project screenshot (3)' },
      { src: '/assets/projects/ankiugen/Ankiugen(4).webp', alt: 'Ankiugen project screenshot (4)' },
      { src: '/assets/projects/ankiugen/Ankiugen(5).webp', alt: 'Ankiugen project screenshot (5)' },
      { src: '/assets/projects/ankiugen/Ankiugen(6).webp', alt: 'Ankiugen project screenshot (6)' },
      { src: '/assets/projects/ankiugen/Ankiugen(7).webp', alt: 'Ankiugen project screenshot (7)' },
      { src: '/assets/projects/ankiugen/Ankiugen(8).webp', alt: 'Ankiugen project screenshot (8)' },
      // { src: '/assets/projects/ankiugen/Ankiugen().webp', alt: 'Ankiugen project screenshot ()' },
    ...
    description:
      ...
      actions: [
        // { label: 'See the Repo', href: '' },
        { label: 'See the Site', href: 'https://ankiugen.com' }
      ],
  },
  {
    title: 'Portfolio Project',
    images: [
      { src: '/assets/projects/portfolio/portfolio(2).webp', alt: 'Portfolio Project Screenshot (2)' },
      { src: '/assets/projects/portfolio/portfolio(1).webp', alt: 'Portfolio Project Screenshot (1)' },
    ],
    description:
    ...
    actions: [
      { label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/JoeyScottSchronce.github.io' },
      { label: 'See the Site', href: 'https://joeyscottschronce.github.io/' },
    ],
  },
  {
    title: 'Text-only apkg Writer',
    images: [
      { src: '/assets/projects/text-only-apkg-writer/textonlyapkgwriter.webp', alt: 'Text-only .apkg Writer' },
      { src: '/assets/projects/text-only-apkg-writer/textonlyapkgwriter-2.webp', alt: 'Text-only .apkg Writer (2)' },
    ],
    description:
  ...
  },
  {
    title: 'BashMaster AI',
    images: [
      { src: '/assets/projects/bashmaster-ai/BashMasterAI.webp', alt: 'BashMaster AI' },
      { src: '/assets/projects/bashmaster-ai/BashMasterAI-2.webp', alt: 'BashMaster AI (2)' },
    ],
    description:
    ...
    actions: [
      { label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/bash-scripting-trainer' },
      { label: 'See the Site', href: 'https://joeyscottschronce.github.io/bash-scripting-trainer' },
    ],
  },
  {
    title: 'Python Training Grounds',
    images: [
      { src: '/assets/projects/python-training-grounds/pythontraininggrounds.webp', alt: 'Python Training Grounds' },
      { src: '/assets/projects/python-training-grounds/pythontraininggrounds-2.webp', alt: 'Python Training Grounds (2)' },
    ],
    description:
    ...
    actions: [
      { label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/python-training-grounds' },
      { label: 'See the Site', href: 'https://joeyscottschronce.github.io/python-training-grounds/' },
    ],
  },
  {
    title: 'Go Concurrency Lab',
    images: [
      { src: '/assets/projects/go-concurrency-lab/goconcurrencylab.webp', alt: 'Go Concurrency Lab' },
      { src: '/assets/projects/go-concurrency-lab/goconcurrencylab-2.webp', alt: 'Go Concurrency Lab (2)' },
    ],
    description:
    ...
    actions: [
      { label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/go-concurrency-lab' },
      { label: 'See the Site', href: 'https://joeyscottschronce.github.io/go-concurrency-lab/' },
    ],
  },
  {
    title: 'Learn Go with Test-Driven Development',
    images: [
      { src: '/assets/projects/learn-go-with-tdd/go_with_tdd.webp', alt: 'Learn Go with TDD screenshot' },
      { src: '/assets/projects/learn-go-with-tdd/go_with_tdd-2.webp', alt: 'Learn Go with TDD screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/golang-practice-with-TDD' }],
  },
  {
    title: 'Frontend Development Capstone Project',
    images: [
      { src: '/assets/projects/frontend-capstone/frontend.webp', alt: 'Frontend Project Screenshot' },
      { src: '/assets/projects/frontend-capstone/frontend-2.webp', alt: 'Frontend Project Screenshot (2)' },
    ],
    description:
    ...
    actions: [
      { label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/frontend_developer_capstone_project' },
      { label: 'See the Site', href: 'https://joeyscottschronce.github.io/frontend_developer_capstone_project/' },
    ],
  },
  {
    title: 'DevOps & Software Engineering Capstone',
    images: [
      { src: '/assets/projects/devops-capstone/DevOps.webp', alt: 'DevOps Project Screenshot' },
      { src: '/assets/projects/devops-capstone/DevOps-2.webp', alt: 'DevOps Project Screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/devops-capstone-project' }],
  },
  {
    title: 'Backend Development Capstone Project',
    images: [
      { src: '/assets/projects/backend-capstone/backend.webp', alt: 'Backend Project Screenshot' },
      { src: '/assets/projects/backend-capstone/backend-2.webp', alt: 'Backend Project Screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/Back-end-Development-Capstone' }],
  },
  {
    title: 'Songs Project for Backend Capstone',
    images: [
      { src: '/assets/projects/songs-backend-capstone/Songs.webp', alt: 'Songs Project Screenshot' },
      { src: '/assets/projects/songs-backend-capstone/Songs-2.webp', alt: 'Songs Project Screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/Back-End-Development-Songs' }],
  },
  {
    title: 'Pictures Project for Backend Capstone',
    images: [
      { src: '/assets/projects/pictures-backend-capstone/Pictures.webp', alt: 'Pictures Project Screenshot' },
      { src: '/assets/projects/pictures-backend-capstone/Pictures-2.webp', alt: 'Pictures Project Screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/Back-End-Development-Pictures' }],
  },
  {
    title: 'Test-driven & Behavior-driven Development',
    images: [
      { src: '/assets/projects/tdd-bdd/TDD_BDD.webp', alt: 'TDD and BDD Project screenshot' },
      { src: '/assets/projects/tdd-bdd/TDD_BDD-2.webp', alt: 'TDD and BDD Project screenshot (2)' },
    ],
    description:
    ...
    actions: [{ label: 'See the Repo', href: 'https://github.com/JoeyScottSchronce/bdd_and_tdd_final_project' }],
  },
]
